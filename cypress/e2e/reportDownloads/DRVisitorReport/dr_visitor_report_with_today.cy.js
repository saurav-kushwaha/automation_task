...
describe('Portal Downloads : quick reports  ', () => {
    ...
    it('should show confirmation message of quick report  after clicking on download for button of DR Visitor Report (Genpact Internal Visitor, External Visitor, Vendor) with today',()=>{
        cy.wait(5000)
