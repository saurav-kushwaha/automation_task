...
describe('Portal Downloads : quick reports  ', () => {
    ...
    it('should show confirmation message of quick report  after clicking on download for button of Cancelled Invite Report with this month',()=>{
        //cy.wait(5000)
        quickReport.getClickOnDownloadCenter();
        quickReport.getClickOnQuickReport();
        quickReport.verifyTitleText().eq(14).should("contain.text", "Cancelled Invite Report")
        quickReport.getClickOnDatePicker().eq(10).click();
        quickReport.getClickOnThisMonth();
        quickReport.getClickOnDownloadForBtn().eq(10).click();
